...
<?php $this->start('body'); ?>
	...
	<form class="my-1 form center-form" method="POST" enctype="multipart/form-data" action="<?= PROJECT_ROOT; ?>register/register">
	   ...
	   <?= FormHelpers::csrf_input(); ?>
		...
		<p>You already have an account ?  <a href="<?= PROJECT_ROOT; ?>register/login"> Login </a></p>
	</form>
